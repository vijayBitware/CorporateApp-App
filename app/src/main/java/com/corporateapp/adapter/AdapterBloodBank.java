...
public class AdapterBloodBank extends RecyclerView.Adapter<AdapterBloodBank.ViewHolder> {

    List<BloodBank> emergencyContactsList = new ArrayList<>();
    private Context context;

    public AdapterBloodBank(Context context, List<BloodBank> arrAmbulance) {
