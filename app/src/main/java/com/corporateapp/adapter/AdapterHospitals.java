...
public class AdapterHospitals extends RecyclerView.Adapter<AdapterHospitals.ViewHolder> {

    List<Hospital> emergencyContactsList = new ArrayList<>();
    private Context context;

    public AdapterHospitals(Context context, List<Hospital> arrAmbulance) {
