...
public class AdapterSuggesion extends RecyclerView.Adapter<AdapterSuggesion.ViewHolder> implements APIRequest.ResponseHandler {

    int curentPosition;
    private List<SuggestionDatum> arrComplaintList;
    private Context context;

    public AdapterSuggesion(Context context, List<SuggestionDatum> galleryList) {
        this.arrComplaintList = galleryList;
        this.context = context;
    }

    @Override
    public AdapterSuggesion.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.suggestion_list_row, viewGroup, false);
        return new AdapterSuggesion.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterSuggesion.ViewHolder holder, final int position) {
        try {
