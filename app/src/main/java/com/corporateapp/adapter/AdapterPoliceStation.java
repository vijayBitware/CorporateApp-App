...
public class AdapterPoliceStation extends RecyclerView.Adapter<AdapterPoliceStation.ViewHolder> {

    List<PolisStation> emergencyContactsList = new ArrayList<>();
    private Context context;

    public AdapterPoliceStation(Context context, List<PolisStation> arrAmbulance) {
