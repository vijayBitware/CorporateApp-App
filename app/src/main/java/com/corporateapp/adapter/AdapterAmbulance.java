...
/**
 * Created by bitware on 23/10/17.
 */

public class AdapterAmbulance extends RecyclerView.Adapter<AdapterAmbulance.ViewHolder> {

    List<Ambulance> emergencyContactsList = new ArrayList<>();
    private Context context;

    public AdapterAmbulance(Context context, List<Ambulance> arrAmbulance) {
